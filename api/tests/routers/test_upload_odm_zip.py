...
# ============================================================================
# EXIF Utilities Tests
# ============================================================================


def test_extract_comprehensive_exif_with_real_image():
...
def test_extract_acquisition_date_with_fake_path():
...
def test_detect_rtk_files_with_rtk_present():
...
def test_detect_rtk_files_without_rtk():
...
def test_parse_rtk_timestamp_file_missing_file():
