...
insert into v2_logs(id,dataset_id,created_at,level,message) select -((d.id-800000000)*100+i),d.id,d.created_at+i*interval '1 minute','INFO',repeat('synthetic log ',50) from v2_datasets d cross join generate_series(1,10)i where d.id>800000000;
