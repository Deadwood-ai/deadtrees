...
- `VITE_POSTHOG_API_HOST` for a managed PostHog reverse proxy such as `https://canopy.deadtrees.earth`; when unset or invalid, analytics safely falls back to direct EU ingestion
...
VITE_POSTHOG_API_HOST=https://canopy.deadtrees.earth
VITE_GEOPIFY_KEY=...
VITE_SUPABASE_SENTINEL_PROCESSING_URL=...
VITE_SUPABASE_SENTINEL_PROCESSING_ANON_KEY=...
```
