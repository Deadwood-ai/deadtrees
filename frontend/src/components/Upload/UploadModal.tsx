    ...
    try {
      ...
      const processingSteps =
        uploadType === UploadType.RAW_IMAGES_ZIP
          ? ["odm_processing", "cog", "thumbnail", "metadata", "geotiff", "deadwood_v1", "treecover_v1"] // Raw images workflow includes ODM
          : ["cog", "thumbnail", "metadata", "geotiff", "deadwood_v1", "treecover_v1"]; // GeoTIFF workflow (no ODM needed)
