    ...
    try {
      ...
      const processingSteps =
        uploadType === UploadType.RAW_IMAGES_ZIP
          ? ["odm_processing", "cog", "thumbnail", "metadata", "geotiff", "deadwood_v1", "treecover_v1", "deadwood_treecover_combined_v2"] // Raw images workflow includes ODM
          : ["cog", "thumbnail", "metadata", "geotiff", "deadwood_v1", "treecover_v1", "deadwood_treecover_combined_v2"]; // GeoTIFF workflow (no ODM needed)
