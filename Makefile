...
COMBINED_MODEL_URL := $(ASSETS_BASE_URL)/models/ckpt_weighted_brownweight15_goldentestweight7.safetensors
...
COMBINED_MODEL := $(MODELS_DIR)/ckpt_weighted_brownweight15_goldentestweight7.safetensors
