drop function if exists public.priwa_project_latest_flight_mosaics(uuid, integer);
...
is 'Returns latest public COG drone datasets uploaded by members of a PRIWA project for authenticated members of that same project, including dataset bbox footprints.';
