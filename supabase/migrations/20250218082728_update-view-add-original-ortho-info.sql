...
alter table "public"."v2_orthos" drop column "ortho_info";

alter table "public"."v2_orthos" add column "ortho_original_info" jsonb;

alter table "public"."v2_orthos" add column "ortho_processed_info" jsonb;
...
create or replace view "public"."v2_full_dataset_view" as  WITH ds AS (
         ...
         SELECT v2_orthos.dataset_id,
            ...
            v2_orthos.bbox,
            v2_orthos.sha256,
            v2_orthos.ortho_processed,
            v2_orthos.ortho_processing_runtime
           FROM v2_orthos
        ), status AS (
