...
def test_all_configurations_standardization(config, test_data_generator, tmp_path):
...
def test_real_world_ten_band_scenario(ten_band_negative_nodata_geotiff, tmp_path):
...
def test_real_world_nan_already_scaled_scenario(nan_already_scaled_geotiff, tmp_path):
...
def test_real_world_uint16_eight_bands_scenario(uint16_eight_bands_alpha_geotiff, tmp_path):
...
def test_real_world_grayscale_large_negative_scenario(grayscale_large_negative_nodata_geotiff, tmp_path):
...
def test_problematic_data_standardization(problematic_geotiff, tmp_path):
...
def test_nodata_detection_comprehensive(test_data_generator):
...
def test_value_range_scaling_comprehensive(test_data_generator, tmp_path):
...
def test_band_reduction_scenarios(test_data_generator, tmp_path):
...
def test_compression_and_layout_handling(test_data_generator, tmp_path):
...
def test_integration_with_processing_pipeline(problematic_geotiff, tmp_path):
...
def test_edge_cases_and_error_scenarios(test_data_generator, tmp_path):
